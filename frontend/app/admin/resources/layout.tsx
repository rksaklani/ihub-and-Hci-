...
export default function ResourcesLayout({
  ...
  const tabs = [
    { 
      id: 'newsletter', 
      label: 'Newsletter', 
      path: '/admin/resources/newsletter',
      icon: 'fas fa-newspaper'
    },
    { 
      id: 'press', 
      label: 'Press', 
      path: '/admin/resources/press',
      icon: 'fas fa-file-alt'
    },
    { 
      id: 'brochure', 
      label: 'Brochure', 
      path: '/admin/resources/brochure',
      icon: 'fas fa-book'
    },
    { 
      id: 'gallery', 
      label: 'Gallery', 
      path: '/admin/resources/gallery',
      icon: 'fas fa-images'
    },
    { 
      id: 'news', 
  ...
  const getActiveTab = () => {
    if (pathname === '/admin/resources') return 'newsletter'
    return tabs.find(tab => pathname === tab.path || pathname.startsWith(tab.path + '/'))?.id || 'newsletter'
  }
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">Manage all resources, media, and publications</p>
            </div>
          </div>
        </div>
      </div>
