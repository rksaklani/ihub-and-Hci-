...
export default function InfrastructureAdmin() {
  ...
  const { data, isLoading, error, refetch } = useGetInfrastructureQuery()
  const [createItem, { isLoading: isCreating }] = useCreateInfrastructureMutation()
  const [updateItem, { isLoading: isUpdating }] = useUpdateInfrastructureMutation()
  const [deleteItem] = useDeleteInfrastructureMutation()
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Office Infrastructure</h1>
        <p className="mt-2 text-sm text-gray-600">Manage office infrastructure information</p>
      </div>

      <div className="glass-strong rounded-xl p-6 border-2 border-primary/10">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-gray-900">Infrastructure Details</h2>
          <button
        ...
        {error ? (
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p>No infrastructure information added yet</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {items.map((item: Infrastructure) => (
