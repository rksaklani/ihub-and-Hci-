...
export default function IHubTeamAdmin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // await fetch('/api/team-members', { method: 'POST', body: JSON.stringify(newMember) })
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">iHub Team</h1>
        <p className="mt-2 text-sm text-gray-600">Manage iHub team members</p>
      </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Enter team member description or position"
                />
              </div>
