...
export default function HubGoverningBodyAdmin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // await fetch('/api/governing-body', { method: 'POST', body: JSON.stringify(newMember) })
      ...
      alert('Governing body member added successfully!')
    } catch (error) {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Hub Governing Body</h1>
        <p className="mt-2 text-sm text-gray-600">Manage hub governing body members</p>
      </div>

      <div className="glass-strong rounded-xl p-6 border-2 border-primary/10">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-gray-900">
            Governing Body Members {members.length > 0 && `(${members.length})`}
          </h2>
          <button 
        ...
        {members.length === 0 ? (
          <div className="text-center py-12 text-gray-500">
            ...
            <p>No governing body members added yet</p>
          </div>
        ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-2xl">
              <h2 className="text-2xl font-bold text-gray-900">Add Governing Body Member</h2>
              <button
