...
export const metadata: Metadata = {
  title: 'Call for Proposals - iHub IIT Mandi',
  description: 'Call for Proposals from iHub IIT Mandi for research and development projects.',
}
    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-primary via-primary-light to-primary-dark text-white py-16 md:py-20 lg:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-2 sm:px-4 md:px-6 text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4 tracking-tight">Call for Proposals</h1>
          <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-6">
            Submit your research and development proposals in Human-Computer Interaction
          </p>
          <nav className="flex justify-center gap-2 text-white/80">
            <Link href="/" className="hover:text-white transition-colors">Home</Link>
            <span>/</span>
            <span className="text-white">Call for Proposals</span>
          </nav>
        </div>
      </div>
